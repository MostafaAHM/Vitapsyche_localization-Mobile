...
import 'package:flutter_mindmed_project/features/On_Board/on_board0.dart';
        ...
        children: [
          PageView(
            ...
            onPageChanged: (index) {
              setState(() {
                onLastpage =
                    (index == 3); // Update to check if index is 3 (last page)
              });
            },
            children: const [
              on_board0(),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () {
                    _controller.jumpToPage(3); // Skip to the last page
                  },
                  child: Text(
                    "Skip",
                ...
                SmoothPageIndicator(
                  controller: _controller,
                  count: 4, // Update to 4 since there are 4 pages
